...
A multi-year project to build a complete computer from scratch — from logic gates on an FPGA, through a custom CPU, toolchain, operating system, filesystem, networking, and GPU — owned at every layer.

Inspired by Bart Pleiter's [FPGC](https://github.com/bartpleiter/FPGC).
